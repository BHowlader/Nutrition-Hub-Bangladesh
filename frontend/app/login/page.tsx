...
function LoginContent() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-ink">
      ...
      <div className="w-full lg:w-[48%] xl:w-[45%] h-full flex flex-col justify-center bg-ink border-r border-cream/5 px-8 sm:px-12 md:px-16 lg:px-20 py-8 overflow-y-auto max-h-screen">
        <div className="w-full max-w-md mx-auto my-auto py-6">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-black text-cream tracking-tight mt-2">Welcome back</h1>
            <p className="text-sm text-cream/50 mt-1">Sign in to your account</p>
          </div>
