        ...
        <div className="w-full max-w-md mx-auto my-auto py-4">
          ...
          {!gsiReady && (
            ...
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32(h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/>
          ...
          <p className="mt-5 md:mt-6 text-center text-sm md:text-base text-cream/50">
            ...
            <Link
              ...
              onClick={(e) => handleNavigate(e, `/login${redirect !== "/" ? `?redirect=${encodeURIComponent(redirect)}` : ""}`)}
