...
function SignupContent() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-ink">
      ...
      {/* Form Portion (Right) */}
      <div className="w-full lg:w-[48%] xl:w-[45%] flex flex-col justify-center px-6 sm:px-12 md:px-16 py-8 overflow-y-auto max-h-screen">
        <div className="w-full max-w-md mx-auto">
          {/* Logo */}
          <Link href="/" className="mb-6 flex items-center gap-3">
            <Image src="/images/logo.png" alt="Nutrition Hub" width={40} height={40} className="rounded-lg" />
            <span>
              <strong className="block text-lg leading-tight text-cream font-black tracking-wide">Nutrition Hub</strong>
              <small className="block text-xs text-cream/60">Bangladesh</small>
            </span>
          </Link>

          <div className="premium-card p-5 md:p-6">
            <h1 className="mb-0.5 text-2xl font-black text-cream">Create account</h1>
            <p className="mb-5 md:mb-6 text-sm text-cream/50">Join Nutrition Hub Bangladesh</p>
