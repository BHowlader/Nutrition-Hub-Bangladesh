...
export function WhatsAppButton() {
  ...
  // On product detail pages, the sticky cart bar takes bottom space on mobile
  ...
  return (
    <a
      ...
      className={`fixed right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_4px_24px_rgba(37,211,102,0.4)] transition-all duration-300 hover:scale-110 hover:shadow-[0_6px_32px_rgba(37,211,102,0.5)] active:scale-95 ${
        isProductPage ? "bottom-[5.5rem] md:bottom-6" : "bottom-6"
      }`}
    >
